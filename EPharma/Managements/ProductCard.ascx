<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProductCard.ascx.cs" Inherits="EPharma.Managements.ProductCard" %>
<style>
    .box {
                ...
                <span>
                    <div class="ourcard">
                        ...
                        <div style="text-align: center;">
                            <asp:Button ID="AddToCart" runat="server" CssClass="btn btn-danger" Text=" + Add to cart" OnClick="AddToCart_Click" CommandArgument='<%#Eval("ID")%>' />
                        </div>
                        <div style="clear: both"></div>
                    </div>
                </span>
